...
function Menu(label) {
    ...
    this.menuItemBgColor = "#F1F1F1";
    this.menuLiteBgColor = "#F1F1F1";
    this.menuBorderBgColor = "#999999";
    this.menuHiliteBgColor = "#CCCCCC";
    this.menuContainerBgColor = "#CCCCCC";
    this.childMenuIcon = "home/images/arrows.gif";
    this.childMenuIconHilite = "home/images/arrows.gif";
...
function showMenu(menu, x, y, child) {
    ...
    if (document.layers) {
        ...
        //alert(l.style.pixelLeft +","+ l.style.pixelTop);
     //   l.style.pixelLeft = 146;
   //     l.style.pixelTop = 146 + countmenu * 22;
   //     alert(window.activeMenus.length);
      //  l.style.pixelTop = 146 + i * 22;
