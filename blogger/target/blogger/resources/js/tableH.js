...
function highlightTableRow(myElement, highlightColor)
{
  ...
  /* Only the formRow Class will be highlighted */
  if (findNode(myElement, "TD").className!="formRowOdd0" && findNode(myElement, "TD").className!="formRowOdd1" && findNode(myElement, "TD").className!="formRowOdd2" &&
	findNode(myElement, "TD").className!="formRowEven0" && findNode(myElement, "TD").className!="formRowEven1" && findNode(myElement, "TD").className!="formRowEven2")
	  {return;}
